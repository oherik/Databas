...
CREATE TABLE Student(
	NationalID CHAR(13) NOT NULL CONSTRAINT student_nationalid_not_empty CHECK(ID <> '             '), CONSTRAINT student_nationalid_not_matching_format  -- TODO sätt constraints!
	SchoolID TEXT NOT NULL CONSTRAINT student_schoolid_not_empty CHECK(ID <> ''),
